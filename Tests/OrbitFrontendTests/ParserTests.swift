...
//            XCTAssertEqual(1, result.body.count)
//
//            let api = result.body[0].expression as! APIExpression
//
...
//
//            XCTAssertEqual(1, result.body.count)
//            XCTAssertTrue(result.body[0].expression is APIExpression)
//            XCTAssertTrue((result.body[0].expression as! APIExpression).body[0] is TraitDefExpression)
//            XCTAssertTrue((result.body[0].expression as! APIExpression).body[1] is MethodExpression)
//            XCTAssertTrue((result.body[0].expression as! APIExpression).importPaths.count == 2)
//            XCTAssertEqual("test.orb", (result.body[0].expression as! APIExpression).importPaths[0].value)
//            XCTAssertEqual("test2.orb", (result.body[0].expression as! APIExpression).importPaths[1].value)
//            XCTAssertEqual("Main", (result.body[0].expression as! APIExpression).within!)
//        } catch let ex as OrbitError {
//            print(ex.message)
//        } catch {
//
